export const PROJECTS_DATA = {
  "frost-core": {
    ...
    descriptionRu: "Мой первый проект в Unreal Engine 5. Учился делать плотное окружение и контрастный свет. Вдохновлялся атмосферой Frostpunk.",
  ...
  "rampage-rally": {
    ...
    descriptionRu: "Первое участие в челлендже Rampage Rally. Перенес идею из 'Назад в будущее' в постсоветский сеттинг: заменил DeLorean на ВАЗ-2108. Сделал за две недели.",
  ...
  "stanley-bottle": {
    ...
    descriptionRu: "Продуктовый стади термокружки Stanley. Настраивал материалы, свет и движения камеры.",
  ...
  "the-visit": {
    ...
    descriptionRu: "Личный проект про зимнюю атмосферу. Хотел передать ощущение вечера перед Новым годом: сани возле избы, тишина и падающий снег.",
