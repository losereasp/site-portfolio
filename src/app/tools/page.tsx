  ...
  return (
    <main className="min-h-screen bg-[#F0F0EE] text-black selection:bg-[#FF5F1F] selection:text-white relative font-sans">
      ...
      <section className="sticky top-20 z-40 px-4 md:px-8 max-w-7xl mx-auto pb-12">
        <div className="flex flex-wrap items-center gap-3 bg-[#F0F0EE]/90 backdrop-blur-md py-3 border-b border-black/15">
          <button
            ...
            className={`font-mono text-xs md:text-sm tracking-widest uppercase px-5 py-2.5 border transition-all cursor-pointer ${
              activeTab === "overview"
                ...
                : "bg-white/60 text-black/70 border-black/15 hover:border-black"
            }`}
          >
