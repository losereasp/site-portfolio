export const PROJECTS_DATA = {
  "frost-core": {
    ...
    categoryEn: "REAL-TIME ENVIRONMENT",
    categoryRu: "РЕАЛЬНОЕ ВРЕМЯ / ОКРУЖЕНИЕ",
    thematicHeader: "Climate Shift",
    thematicHeaderEn: "Climate Shift",
    thematicHeaderRu: "Климатический Сдвиг",
    ...
    descriptionEn: "My debut project in Unreal Engine 5, created as part of my learning journey. The work is inspired by the grim atmosphere and aesthetic of Frostpunk. In this scene, I focused on building a dense cinematic environment and mastering high-contrast lighting.",
    descriptionRu: "Мой дебютный проект в Unreal Engine 5, созданный в рамках обучения. Работа вдохновлена мрачной атмосферой и эстетикой Frostpunk. В этой сцене я сосредоточился на создании плотного кинематографичного окружения и работе с контрастным освещением.",
  ...
  "rampage-rally": {
    ...
    descriptionEn: "My first run at the Rampage Rally community challenge. Inspired by 'Back to the Future,' but rebuilt in a post-Soviet setting — I swapped the iconic DeLorean for a VAZ-2108, the car everyone here grew up with. A two-week sprint, and my first real step toward finding my own style.",
    descriptionRu: "Мое первое участие в челлендже Rampage Rally. Вдохновлено 'Назад в будущее', но переосмыслено в постсоветском сеттинге — культовый DeLorean я заменил на ВАЗ-2108, машину из нашего детства. Двухнедельный спринт и мой первый реальный шаг к поиску собственного стиля.",
  ...
  "stanley-bottle": {
    ...
    categoryEn: "CGI & 3D MOTION",
    categoryRu: "3D-ГРАФИКА И АНИМАЦИЯ",
    ...
    descriptionEn: "A product visualization and look-development study of the iconic Stanley Tumbler. This project highlights premium material design, high-fidelity light play, and detailed product cinematography.",
    descriptionRu: "Визуализация продукта и исследование look-development для культового термостакана Stanley. Проект демонстрирует работу с премиальными материалами, игру света и детальную презентацию продукта.",
  ...
  "the-visit": {
    ...
    categoryEn: "ENVIRONMENT & STORYTELLING",
    categoryRu: "ОКРУЖЕНИЕ И СТОРИТЕЛЛИНГ",
    ...
    descriptionEn: "A personal project exploring winter atmosphere and storytelling. My goal was to capture the nostalgic feeling of New Year's Eve in a village — a sleigh arriving at a warm-lit izba, snow falling softly, the quiet of a winter night.",
    descriptionRu: "Персональный проект, исследующий зимнюю атмосферу и сторителлинг. Моей целью было передать ностальгическое чувство новогодней ночи в деревне — сани возле теплой избы, тихо падающий снег и тишина зимней ночи.",
